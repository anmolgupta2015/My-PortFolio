        ...
        <section className="banner" id="home">
            <Container>
                <Row className="align-items-center">
                    ...
                    <h1>{`Hi I'm Anmol Gupta New `} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Web Developer", "Web Designer", "Tech Enthausiast" ]'></span> <span className="wrap">{text}</span> </h1>
